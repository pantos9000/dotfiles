...
map('n', '<C-k>', '10<Up>', { desc = '10 up' })
map('v', '<C-k>', '10<Up>', { desc = '10 up' })
map('i', '<C-k>', '<C-o>10<Up>', { desc = '10 up' }) -- TODO does not work
map('n', '<C-Down>', '10<Down>', { desc = '10 down' })
map('v', '<C-Down>', '10<Down>', { desc = '10 down' })
map('i', '<C-Down>', '<C-o>10<Down>', { desc = '10 down' })
map('n', '<C-j>', '10<Down>', { desc = '10 down' })
map('v', '<C-j>', '10<Down>', { desc = '10 down' })
map('i', '<C-j>', '<C-o>10<Down>', { desc = '10 down' }) -- TODO does not work
map('n', '<C-Left>', 'b', { desc = '1 word back' })
map('v', '<C-Left>', 'b', { desc = '1 word back' })
map('i', '<C-Left>', '<C-o>b', { desc = '1 word back' })
map('n', '<C-h>', 'b', { desc = '1 word back' })
map('v', '<C-h>', 'b', { desc = '1 word back' })
map('i', '<C-h>', '<C-o>b', { desc = '1 word back' })
map('n', '<C-Right>', 'w', { desc = '1 word forward' })
map('v', '<C-Right>', 'w', { desc = '1 word forward' })
map('i', '<C-Right>', '<C-o>w', { desc = '1 word forward' })
map('n', '<C-l>', 'w', { desc = '1 word forward' })
map('v', '<C-l>', 'w', { desc = '1 word forward' })
map('i', '<C-l>', '<C-o>w', { desc = '1 word forward' })
