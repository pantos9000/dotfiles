...
swaymsg "workspace \$WS_1  output $laptop, workspace \$WS_1,  move workspace to $laptop"
swaymsg "workspace \$WS_2  output $laptop, workspace \$WS_2,  move workspace to $laptop"
swaymsg "workspace \$WS_3  output $laptop, workspace \$WS_3,  move workspace to $laptop"
swaymsg "workspace \$WS_4  output $laptop, workspace \$WS_4,  move workspace to $laptop"
swaymsg "workspace \$WS_5  output $laptop, workspace \$WS_5,  move workspace to $laptop"
swaymsg "workspace \$WS_6  output $laptop, workspace \$WS_6,  move workspace to $laptop"
swaymsg "workspace \$WS_7  output $laptop, workspace \$WS_7,  move workspace to $laptop"
...
swaymsg "workspace tmp, workspace \$WS_1, workspace \$WS_F1, workspace \$WS_F3"
